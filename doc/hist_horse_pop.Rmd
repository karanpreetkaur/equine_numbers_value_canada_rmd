...
```{r plot province, fig.width=5, fig.height=4, fig.cap=paste("Figure.2. Historical number of horses in", params$province, "province of Canada"), out.width='100%'}
province_plot <- horse_pop %>% 
  ...
  xlab("Year") +
  ylab("Number of horses") +
  ggtitle(paste("Historical number of horses in", params$province, "of Canada")) +
  facet_grid(~GEO) +
  scale_y_continuous(labels = scales::comma) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
province_plot
